...
public interface RoleService {
    ...
    /**
     * Unassign an assigned {@code Grant} from a {@code Role}.
     *
     * @param pKey The persistent key of the existing Role
     * @param grantPKey The persistent key of the existing Grant
     * @return The updated Role instance
     */
    @NotNull RoleVO unassignGrant(@NotBlank String pKey, @NotBlank String grantPKey);
}